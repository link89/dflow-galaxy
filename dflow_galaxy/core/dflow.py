...
class DFlowBuilder:
    ...
    def __init__(self, name:str, s3_prefix: str,
                 debug=False,
                 executor: Optional[dflow.Executor] = None,
                 container_base_dir: str = '/tmp/dflow-builder', s3_debug_fn = shutil.copy):
        """
        ...
        :param executor: The default executor to run the workflow.
        ...
        if debug:
            ...
            if executor is not None:
                logger.warning('dflow: executor is ignored in debug mode')
                executor = None
