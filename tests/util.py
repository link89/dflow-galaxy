...
# end of bash_select_chunk"""
    ...
    def test_bash_iter_selected_chunk(self):
        actual = util.bash_iter_selected_chunk(
            in_file='in_file', script='echo $ITEM', it='ITEM', n=2, i=1)
        expected = """# generated by: bash_select_chunk(in_file, 2, 1, chunk.tmp.txt)
python << EOF > chunk.tmp.txt
import sys
with open('in_file', 'r') as f:
    lines = f.readlines()
lines = [line for line in lines if line.strip()]
